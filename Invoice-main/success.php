            ...
            <section class="top-content bb d-flex justify-content-between">
                ...
                <div class="top-left">
                    ...
                    <div class="position-relative">
                        <p>#XXXX<?php echo rand (1000,10000);?><span></span></p>
                    </div>
                </div>
            </section>
                ...
                <div class="col-10">
                    <div class="row bb pb-3">
                        <div class="col-7">
                            ...
                            <div class="txn mt-2">Customer ID:#<?php echo $_SESSION["CUST_ID"];?></div>
                        </div>
                    ...
                    <div class="row extra-info pt-3">
                        <div class="col-7">
                            ...
                            <p>Order ID: <span> #<?php echo $_SESSION["ORDER_ID"];?></span></p>
                        </div>
                        <div class="col-5">
            ...
            <section class="balance-info">
                <div class="row">
                    <div class="col-8">
                        ...
                        <p>Please download the copy of this invoice by clicking the download button.</p>
                    </div>
